  ...
  SecureRandom getSecureRandom() {
    ...
    for (int i = 0; i < seed.length; i++) {
      seed[i] = random.nextInt(
          256); //Popola l'array seed lungo 32 byte con numeri casuali compresi tra 0 e 255
    }
    secureRandom.seed(
        KeyParameter(seed)); //Inizializza FortunaRandom con il seed popolato
    return secureRandom;
  }
...
//Cripta una stringa e restituisce il risultato in base 64
  ...
  Future<String?> rsaDecryptBase64(String cipherText,
